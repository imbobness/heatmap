USE [ManufacturingDB]
GO
/****** Object:  StoredProcedure [dbo].[HeatMap3GTLast48HoursLoader_Canary_RobertDees]    Script Date: 9/22/2026 8:40:17 AM ******/
SET ANSI_NULLS ON
GO
...
Force a full 48-hour rebuild after correcting tag mappings:
    EXEC dbo.HeatMap3GTLast48HoursLoader_Canary_RobertDees
        ...
        @ReloadExisting = 1;
***************************************************************************************************************/
ALTER   PROCEDURE [dbo].[HeatMap3GTLast48HoursLoader_Canary_RobertDees]
...
WHERE productionLine.ProductionInd = 'Y'
  ...
  AND target.DateTimeFrom < @LastHour;
        ...
        ********************************************************************************************************/
        /*
            Compatibility fix: stage historian values until Oracle lot metadata is available.
            The working original procedure did not insert incomplete rows into the final table.
        */
        CREATE TABLE #CanaryValues
        (
            LineID TINYINT NOT NULL,
            DateTimeFrom SMALLDATETIME NOT NULL,
            DateTimeTo SMALLDATETIME NOT NULL,
        ...
        ********************************************************************************************************/
        ...
        /*
            Compatibility fix: insert the completed row only after matching Brand and SpherePower.
            This preserves the output behavior of HeatMap3GTLast48HoursLoader_Canary.
        */
        ...
        SELECT
            ...
            lot.Brand,
            lot.SpherePower
        FROM #CanaryValues AS valuesToLoad
